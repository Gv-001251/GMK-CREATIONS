...
export default function PortfolioPage() {
  return (
    <main className="bg-black min-h-screen text-white flex flex-col">
      ...
      <div className="pt-32 pb-24 px-4 sm:px-6 max-w-350 mx-auto w-full flex-1 flex flex-col items-center">
        {/* Left-aligned Hero Block */}
        <div className="w-full max-w-237.5 flex flex-col items-start text-left mt-8 sm:mt-12 px-4">
        ...
        <div className="w-full max-w-237.5 text-left mt-10 mb-16 px-4">
        ...
        <div className="relative w-full max-w-237.5 aspect-16/8.5 sm:aspect-16/7.5 md:aspect-16/7 flex items-end justify-center mb-22 overflow-visible px-4 sm:px-0 -translate-y-12">
          ...
          <div className="absolute bottom-0 h-[122%] w-70 sm:w-120 md:w-145 lg:w-170 z-10 overflow-visible flex items-end justify-center -translate-x-12">
            <Image
        ...
        <div className="w-full flex flex-col items-center mb-12">
          ...
          <div className="flex flex-wrap items-center justify-center gap-10 sm:gap-12 md:gap-16 w-full max-w-5xl px-4 py-8">
            ...
            {/* Autodesk Fusion 360 */}
            <div className="flex items-center gap-2.5 shrink-0 hover:scale-105 transition-transform duration-300 select-none">
              <img 
